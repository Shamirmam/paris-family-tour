      ...
      <nav className={`fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? 'bg-white/95 backdrop-blur-sm shadow-md py-3' : 'bg-transparent py-5'}`}>
        <div className="container mx-auto px-6 flex justify-between items-center">
          <a href="#" className="flex items-center space-x-2">
            <div className="font-nunito font-black text-xl md:text-2xl text-orange-primary tracking-tighter italic">
              Paris<span className="text-text-main">Family</span>Tour
            </div>
          </a>
